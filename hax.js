(function(qc) {
    ...
    function Ya(a) {
        ...
        this.Th(c.get("green-list"), this.ab, p.Xd, a);
    ...
    ub.cq = function(a) {
        ...
        case "green":
        	...
        	b.ea = p.Xd;
        default:
            throw new q('First argument must be either "red", "blue" or "green"""');
        }
        if ("clear" == a[2])
            return b;
    ...
    ub.prototype = {
        gf: function(a) {
            ...
            case "extrapolation":
                ...
                this.ya.gm(a),
                this.ba("Extrapolation set to " + a + " msec")) : this.ba("Extrapolation must be a value between -200 and 50 milliseconds")) : this.ba("Extrapolation requires a value in milliseconds.");
                break;
            case "handicap":
                2 == a.length ? (a = K.parseInt(a[1]),
